...
# variables for comparing time of LCG and XORSHIFT
lcg_time, xorshift_time = 0, 0

# 10 random numbers using LCG
...
# 10 random numbers using XORSHIFT
...
#  10 random numbers using Mersenne-twister 
...
# 10 random numbers using Blum Blum Shub
...
# Checking randomness of numbers generated by each algorithm
...
# Comparing time required by LCG and XORshift
